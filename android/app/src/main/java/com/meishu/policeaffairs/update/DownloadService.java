...
public class DownloadService extends IntentService {
    ...
    public void onHandleIntent(Intent intent) {
        UpgradeModule.sendLog("start");
        Toast.makeText(getApplicationContext(), "DownloadService", Toast.LENGTH_LONG).show();
        ...
        try {
            ...
            UpgradeModule.sendLog(e.getMessage());
            UpgradeModule.sendError("更新错误,请检查您的网络连接");
        } finally {
            if (out != null) {
                try {
                    out.close();
