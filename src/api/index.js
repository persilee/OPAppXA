...
export default  {
    ...
    getAlarmDealData: `${newUrl}/api/alarm/deal`, //首页报警任务处理
    getOldManList: `${newUrl}/api/roomUser/oldList`, //获取高龄老人列表
    ...
    getEmphasisList: `${baseUrl}/mqi/pageOrData/aa978659c1b94600b550415f49c6c0bd`, // 获取重房点核查数据
    getVacancyList: `${baseUrl}/mqi/pageOrData/6668693ae29f4a44b5da4e7052e073e7`, // 获取空置房核查数据
    getMultiUserList: `${baseUrl}/mqi/pageOrData/91def9cfa2d744bcae5a8f938aeec25f`, // 获取空置房核查数据
    addCheckResult: `${baseUrl}/api/appserver/room/insert`, // 新增核查历史
