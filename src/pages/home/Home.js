...
let itemArr = [
	{
		...
		color: '#B9E669',
		isImage: true,
		name: require('../../../assets/images/Basis.png'),
		iconOutSize: 48,
		height: 66,
		iconSize: 30,
		page: 'Basis',
	...
	},
	{
		...
		color: '#FCC23F',
		isImage: true,
		name: require('../../../assets/images/RealTime.png'),
		iconOutSize: 48,
		height: 66,
		iconSize: 30,
		page: 'RealTime',
	...
	},
	{
		...
		color: '#FEA095',
		isImage: true,
		name: require('../../../assets/images/Task.png'),
		iconOutSize: 48,
		height: 66,
		iconSize: 30,
		page: 'Task',
	...
	// },
	{
		...
		color: '#89DBFD',
		isImage: true,
		name: require('../../../assets/images/Face.png'),
		iconOutSize: 48,
		height: 66,
		iconSize: 30,
		page: 'Face',
	...
	},
	{
		...
		color: '#FCC23F',
		isImage: true,
		name: require('../../../assets/images/Joint.png'),
		iconOutSize: 48,
		height: 66,
		iconSize: 30,
		page: 'Joint',
	...
	},
	{
		...
		color: '#B9E669',
		isImage: true,
		name: require('../../../assets/images/ItPolice.png'),
		iconOutSize: 48,
		height: 66,
		iconSize: 30,
		page: 'ItPolice',
	...
	},
	{
		...
		color: '#89DBFD',
		isImage: true,
		name: require('../../../assets/images/Duty.png'),
		iconOutSize: 48,
		height: 66,
		iconSize: 30,
		page: 'Duty',
	...
	},
	{
		...
		color: '#FD6D6D',
		isImage: true,
		name: require('../../../assets/images/Alarm.png'),
		iconOutSize: 48,
		height: 66,
		iconSize: 30,
		page: 'Alarm',
			...
			>
				<View style={[ GlobalStyles.headerBg, { position: 'relative', marginBottom: 20, paddingTop: 20 } ]}>
					<View style={[ styles.contentContainer, GlobalStyles.flexDirectRow, GlobalStyles.center ]}>
						<Image
							source={require('../../../assets/images/police_badge.png')}
						...
						<View style={[ GlobalStyles.flex ]}>
							{this.props.User.userPosi == '0' ? (
								<Text style={[ GlobalStyles.font14White, GlobalStyles.mb5 ]}>
									民警：{this.props.User.userNameChn}
								</Text>
							) : (
								<View>
									<Text style={[ GlobalStyles.font14White, GlobalStyles.mb5 ]}>
										辅警：{this.props.User.userNameChn}
									</Text>
									<Text style={[ GlobalStyles.font14White, GlobalStyles.mb5 ]}>
										隶属民警：{this.props.User.superName}
									</Text>
								</View>
							)}
							<Text style={[ GlobalStyles.font14White, GlobalStyles.mb5 ]}>
						...
						>
							...
							>
								...
								<TextInput
									...
									style={[ GlobalStyles.flex, GlobalStyles.font14White, styles.textInput ]}
									placeholder={'请输入关键字'}
							...
							<TouchableOpacity onPress={() => this.userPress('QuickSearch')}>
								<Text
									style={[
										...
										GlobalStyles.homeSearchBorderLeftColor,
										{ paddingLeft: 10, paddingRight: 10, borderLeftWidth: 1 }
									]}
								>
									警务快搜
								</Text>
					...
					{filterArr.map((item, index) => {
						return (
							<HomeTextImage
								...
								key={`${item.moduCode}-${index}`}
								name={item.name}
								iconOutSize={item.iconOutSize}
								height={item.height}
				...
				{this.findmoduleIndex('TodayAlarm') > -1 ? (
					<View>
						...
						<View style={GlobalStyles.pdlr15}>
							...
							>
								<Text style={[ GlobalStyles.font15Gray, GlobalStyles.mt10, GlobalStyles.mb10 ]}>
									今日报警
								</Text>
								...
								{this.state.alarmLst.map((item, index) => {
									...
									return (
										...
										>
											...
											/>
											<Text
												style={[ GlobalStyles.font14White, GlobalStyles.flex ]}
												ellipsizeMode="tail"
												numberOfLines={1}
											>
												{index + 1}.{item.alarmType}：{item.alarmTime}
											</Text>
										</TouchableOpacity>
									);
								})}
