...
export default class CommunityScene extends Component {
    ...
    */
    doFetch = () => {
        ...
        CommonFetch.doFetch(RoutApi.getEntranceComList,params,this.dealResponseData,this.refs.toast)
    }
    ...
    render() {
        ...
        return (
            <View style={[GlobalStyles.pageBg,{ marginTop: 4}]}>
